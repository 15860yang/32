...
// FIFO 写复位
#define      OV7725_WRST_GPIO_CLK                     RCC_APB2Periph_GPIOA
#define      OV7725_WRST_GPIO_PORT                    GPIOA
#define      OV7725_WRST_GPIO_PIN                     GPIO_Pin_12
...
#define      OV7725_DATA_GPIO_PORT2                   GPIOC
...
#define READ_FIFO_PIXEL(RGB565)   	do{\
	                                  RGB565=0;\
	                                  FIFO_RCLK_L();\
	                                  RGB565 = ((OV7725_DATA_GPIO_PORT->IDR) & 0xf000) | ((OV7725_DATA_GPIO_PORT2->IDR) & 0x0f00);\
	                                  FIFO_RCLK_H();\
                                    FIFO_RCLK_L();\
	                                  RGB565 |= ((OV7725_DATA_GPIO_PORT->IDR >>8) & 0x00f0) | ((OV7725_DATA_GPIO_PORT2->IDR >>8) & 0x000f);\
	                                  FIFO_RCLK_H();\
                                    }while(0)
