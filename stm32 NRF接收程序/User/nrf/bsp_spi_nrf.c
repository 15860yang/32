...
#include "bsp_spi_nrf.h"
 ...
 u8 TX_ADDRESS[TX_ADR_WIDTH] = {0x30,0x30,0x30,0x30,0x30};  // 定义一个静态发送地址
 u8 RX_ADDRESS[RX_ADR_WIDTH] = {0x30,0x30,0x30,0x30,0x30};
...

{
   ...
   SPI_NRF_WriteReg(NRF_WRITE_REG+RF_CH,0x88);      //设置RF通信频率    
